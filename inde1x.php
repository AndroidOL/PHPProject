<html>
	...
	<?php
		...
		if (isset($_SESSION["admin"]) && $_SESSION["admin"] === true) {
			echo "欢迎您，尊敬的 " . $_SESSION["username"] . "，<a href='./PHP/voteNote.php?page=1&display=default'>进入留言</a> | <a href='./PHP/Login.php?action=Logout'>注销账户</a>。";
	...
	<div class="main">
		<div>
			<h1 id="topG">报名查询管理系统</h1>
			<input type="button" onclick="checkCookies();" value="出现问题？" /></p>
		</div>
		...
		<div style="width:45%; height:auto; float:left; clear:both" <?php if(isset($checkByADMIN)){echo $checkByADMIN;}else{}?>>
